...
def train_and_predict_v9():
    ...
    # STRICT FEATURE SELECTION: Drop highly correlated/redundant features
    # Keeping only the absolute strongest independent signals to prevent overfitting
    selected_features = [
    ...
    print(f"Training on simplified feature space ({len(selected_features)} features)...")
    ...
    sub_path = "submissions/submission_v9.csv"
